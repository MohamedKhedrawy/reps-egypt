          ...
          <div className="grid md:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="md:col-span-3">
              ...
              <div className="flex gap-4">
                  {/* Facebook */}
                  <Link href="#" className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center hover:bg-red-600 hover:text-white transition-all cursor-pointer text-gray-400">
