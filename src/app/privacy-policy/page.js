    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-12 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">Values that drive our commitment to your privacy</p>
          <p className="text-xs text-gray-500 mt-4">Last Updated: January 28, 2026</p>
        </div>
        ...
        <div className="space-y-8">
            ...
            <div className="bg-[#121212] border border-white/5 rounded-2xl p-8">
                ...
                <div className="bg-[#1a1a1a] p-4 rounded-xl border-l-4 border-red-900/50">
        ...
        <div className="mt-16 text-center border-t border-white/5 pt-12">
            ...
            <a href="mailto:privacy@repsegypt.com" className="text-red-500 hover:text-white font-bold transition-colors">privacy@repsegypt.com</a>
        </div>
