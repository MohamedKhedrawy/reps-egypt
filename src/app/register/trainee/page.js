    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted">Join Reps Egypt and start your fitness journey today</p>
        </div>
        ...
        <div className="max-w-lg mx-auto mb-12">
          <div className="flex items-center w-full">
            ...
            {/* Line 2 (Gray) */}
            <div className="flex-1 h-[2px] bg-background-border mx-2"></div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="absolute top-12 whitespace-nowrap text-[10px] font-bold text-muted uppercase tracking-wider">Additional Details</div>
            </div>
        ...
        <div className="bg-secondary border border-border rounded-3xl p-8 md:p-10 shadow-2xl">
           ...
           <div className="mb-8">
              ...
              <div className="flex items-center gap-4">
                 <div className="w-20 h-20 rounded-full bg-tertiary border border-border flex items-center justify-center text-muted">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                    </svg>
                 </div>
                 <button className="px-5 py-2.5 bg-tertiary hover:bg-background border border-border rounded-lg text-sm font-medium transition-colors flex items-center gap-2 text-foreground">
           ...
           <form className="space-y-6" onSubmit={handleNext}>
              ...
              <div className="space-y-2">
                 ...
                 <div className="relative group">
                    ...
                    <input required type="text" className="w-full bg-tertiary border border-border rounded-xl pl-12 pr-4 py-3.5 text-sm text-foreground placeholder-muted focus:outline-none focus:border-red-600 transition-colors" placeholder="Enter your full name" />
                 </div>
              </div>
              ...
              <div className="space-y-2">
                 ...
                 <div className="relative group">
                    ...
                    <input required type="email" className="w-full bg-tertiary border border-border rounded-xl pl-12 pr-4 py-3.5 text-sm text-foreground placeholder-muted focus:outline-none focus:border-red-600 transition-colors" placeholder="your.email@example.com" />
                 </div>
              </div>
              ...
              <div className="space-y-2">
                 ...
                 <div className="relative group">
                    ...
                    <input required type="tel" className="w-full bg-tertiary border border-border rounded-xl pl-12 pr-4 py-3.5 text-sm text-foreground placeholder-muted focus:outline-none focus:border-red-600 transition-colors" placeholder="+20 123 456 7890" />
                 </div>
              </div>
