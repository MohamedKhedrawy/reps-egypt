        ...
        <div className="max-w-lg mx-auto mb-12">
          <div className="flex items-center w-full">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="absolute top-12 whitespace-nowrap text-[10px] font-bold text-gray-500 uppercase tracking-wider">Professional</div>
            </div>
        ...
        <div className="bg-[#121212] border border-white/5 rounded-3xl p-8 md:p-10 shadow-2xl">
           ...
           <form className="space-y-6" onSubmit={handleNext}>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                   ...
                   <input 
                     ...
                     value={formData.age} 
                     type="text" 
                     className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-red-600 transition-colors cursor-not-allowed opacity-70" 
              ...
              <div className="pt-4 border-t border-white/5">
                <h3 className="text-sm font-semibold text-white mb-4">Social Media Links <span className="text-gray-500 font-normal">(Optional)</span></h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                     ...
                     <div className="relative group">
                        ...
                        <input name="facebook" value={formData.facebook} onChange={handleChange} type="url" className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors" placeholder="https://facebook.com/..." />
                     </div>
                  </div>
                  ...
                  <div className="space-y-2">
                     ...
                     <div className="relative group">
                        ...
                        <input name="instagram" value={formData.instagram} onChange={handleChange} type="url" className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-pink-500 transition-colors" placeholder="https://instagram.com/..." />
                     </div>
                  </div>
                  ...
                  <div className="space-y-2">
                     ...
                     <div className="relative group">
                        ...
                        <input name="youtube" value={formData.youtube} onChange={handleChange} type="url" className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-red-500 transition-colors" placeholder="https://youtube.com/..." />
                     </div>
                  </div>
                  ...
                  <div className="space-y-2">
                     ...
                     <div className="relative group">
                        ...
                        <input name="linkedin" value={formData.linkedin} onChange={handleChange} type="url" className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-400 transition-colors" placeholder="https://linkedin.com/in/..." />
                     </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 mt-8 pt-4">
                 <Link href="/register/trainer" className="w-full md:w-auto px-8 py-3.5 bg-transparent border border-white/10 hover:bg-white/5 text-white font-bold rounded-xl transition-colors text-center">
                   Back
                 </Link>
