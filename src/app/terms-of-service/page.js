    ...
    <div className="min-h-screen bg-background text-foreground pt-12 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted">Please read these terms carefully before using our platform</p>
          <p className="text-xs text-muted mt-4">Effective Date: January 1, 2026</p>
        </div>
        ...
        <div className="space-y-8">
            ...
            {/* Section 2 */}
            <div className="bg-secondary border border-border rounded-2xl p-8">
                <h2 className="text-xl font-bold text-foreground mb-4">2. User Responsibilities</h2>
                <div className="text-muted text-sm leading-relaxed">
            ...
            {/* Section 3 */}
            <div className="bg-secondary border border-border rounded-2xl p-8">
                <h2 className="text-xl font-bold text-foreground mb-4">3. Certification & Accreditation</h2>
                <div className="text-muted text-sm leading-relaxed">
                    <p className="mb-4">
        ...
        <div className="mt-16 text-center border-t border-border pt-12">
            <p className="text-muted mb-4">Questions about the Terms of Service?</p>
