  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 py-24">
      ...
      <div className="text-center mb-16 max-w-2xl">
        ...
        <p className="text-muted text-lg">Join Reps Egypt and start your fitness journey today. Choose the account type that suits you best.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full">
        ...
        {/* Trainee Card */}
        <Link href="/register/trainee" className="group relative bg-secondary border border-border rounded-2xl p-8 hover:border-red-600 transition-all duration-300 hover:shadow-[0_0_30px_rgba(220,38,38,0.1)] flex flex-col">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-3">Trainee</h2>
        ...
        {/* Trainer Card */}
        <Link href="/register/trainer" className="group relative bg-secondary border border-border rounded-2xl p-8 hover:border-red-600 transition-all duration-300 hover:shadow-[0_0_30px_rgba(220,38,38,0.1)] flex flex-col">
          <div className="w-14 h-14 rounded-xl bg-tertiary border border-border flex items-center justify-center mb-6 group-hover:bg-red-600 group-hover:text-white transition-colors text-red-500">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
          ...
          <h2 className="text-2xl font-bold text-foreground mb-3">Trainer</h2>
          <p className="text-muted text-sm mb-8 leading-relaxed">
