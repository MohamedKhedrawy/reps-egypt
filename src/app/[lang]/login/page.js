...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors(prev => ({ ...prev, general: err.message || "Invalid credentials. Please try again." }));
    } finally {
           ...
           <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-red-500 hover:text-red-400 transition-colors">Forgot Password?</Link>
                </div>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-500 group-focus-within:text-red-500 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="remember" className="text-sm text-muted cursor-pointer">Remember me for 30 days</label>
              </div>
