  ...
  const benefits = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-white group-hover:text-red-500 transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
           <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
             <div className="max-w-3xl">
                ...
                <p className="text-gray-400 text-lg">Join a network of over 5,000 certified professionals and unlock tools to accelerate your career.</p>
             </div>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
           {benefits.map((item, idx) => (
             <div key={idx} className="group p-8 bg-[#121212] border border-white/5 rounded-3xl hover:border-red-600/30 transition-all duration-300 hover:-translate-y-1 shadow-2xl">
                <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center mb-6 border border-white/5 group-hover:bg-red-600/10 group-hover:border-red-600/20 transition-colors">
                  {item.icon}
                </div>
        ...
        <div className="rounded-3xl bg-white/[0.02] border border-white/5 overflow-hidden">
           <div className="p-8 md:p-12 border-b border-white/5 text-center">
             ...
             <p className="text-gray-400">Choose the level that suits your professional goals</p>
           </div>
           ...
           <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/5">
              ...
              <div className="p-8 md:p-12 hover:bg-white/[0.02] transition-colors">
                 <div className="text-lg font-bold text-gray-400 mb-2">Student</div>
                 ...
                 <button className="w-full py-3 border border-white/10 rounded-xl font-bold text-sm hover:bg-white hover:text-black transition-colors">Register</button>
              </div>
              
              {/* Tier 2 */}
              <div className="p-8 md:p-12 bg-white/[0.02] relative overflow-hidden">
                 ...
                 <div className="text-3xl font-bold text-white mb-6">1,200 EGP<span className="text-sm font-normal text-gray-500">/yr</span></div>
               ...
               {/* Tier 3 */}
              <div className="p-8 md:p-12 hover:bg-white/[0.02] transition-colors">
                 <div className="text-lg font-bold text-gray-400 mb-2">Master Coach</div>
                 <div className="text-3xl font-bold text-white mb-6">2,500 EGP<span className="text-sm font-normal text-gray-500">/yr</span></div>
                 <ul className="space-y-4 mb-8 text-sm text-gray-400">
                 ...
                 <button className="w-full py-3 border border-white/10 rounded-xl font-bold text-sm hover:bg-white hover:text-black transition-colors">Contact Us</button>
              </div>
           </div>
        </div>
      </section>
